    ...
    return !contactController.contactIsLoading
        ? AzListView(
            ...
            indexBarOptions: IndexBarOptions(
                needRebuild: true,
                textStyle: montserratRegular.copyWith(color: ColorResources.getPrimaryColor(), fontSize: Dimensions.FONT_SIZE_SMALL),
                selectTextStyle: montserratRegular.copyWith(color: ColorResources.getPrimaryColor(), fontSize: Dimensions.FONT_SIZE_SMALL),
                selectItemDecoration: BoxDecoration(shape: BoxShape.circle, color: Theme.of(context).secondaryHeaderColor)),
            itemBuilder: (context, index) => contactController.filterdContacts[index] == null
                ? SizedBox()
                : Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: contactController.filterdContacts[index].isShowSuspension
