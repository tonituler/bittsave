...
import 'package:bittsave/view/screens/home/loan/application_succesfful.dart';
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      titleText(
                        '${PriceConverter.priceFormater(balance: PriceConverter.convertToNaira(double.parse(splashController.configModel.loanCommissionUsd) / 100) * double.parse(widget.loanInfo["loan_amount"].toString()))} NGN',
                      ),
                      SizedBox(height: 16),
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      subText('Transfer fee'),
                      titleText(
                          '\$${PriceConverter.priceFormater(balance: ((double.parse(splashController.configModel.loanCommissionUsd.toString()) / 100) * double.parse(widget.loanInfo["loan_amount"].toString())))}'),
                      SizedBox(height: 16),
                      subText('Payment Amount'),
                      titleText(
                          '\$${PriceConverter.priceFormater(balance: (double.parse(widget.loanCalculation["loan_amount"].toString()) - ((double.parse(splashController.configModel.loanCommissionUsd.toString()) / 100) * double.parse(widget.loanInfo["loan_amount"].toString()))))}'),
                      SizedBox(height: 40),
                      Container(
                        height: 50,
                        width: MediaQuery.of(context).size.width,
