...
// import 'package:bittsave/view/screens/transaction_money/widget/show_amount_view.dart';
...
//                       child: Text('4digit_pin'.tr, style: montserratMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE))),
//                   Row(
...
//                             obscureText: true,
//                             hintCharacter: '•',
//                             hintStyle: montserratMedium.copyWith(color: ColorResources.getGreyBaseGray4()),
...
//                                                         amountCharge: Get.find<SplashController>().configModel.sendMoneyChargeFlat,
...
//                                             return verifyController.isVerifying
//                                                 ? CircularProgressIndicator(color: ColorResources.getPrimaryTextColor())
//                                                 : SizedBox.shrink();
//                                           })
//                                         ],
//                                       ),
...
//                           });
//                         }
//                       }, child: GetBuilder<AuthController>(builder: (otpCheckController) {
//                         return GetBuilder<TransactionMoneyController>(builder: (pinVerify) {
