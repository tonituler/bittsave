        ...
        child: Column(
          ...
          children: [
            ...
            Container(
                ...
                child: SizedBox(height: 25, width: 25, child: Image.asset(image, fit: BoxFit.contain))),
            const SizedBox(height: 10),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_EXTRA_SMALL + 1),
              child: Text(
                text,
                textAlign: TextAlign.center,
                maxLines: 2,
                style: montserratRegular.copyWith(fontSize: Dimensions.FONT_SIZE_DEFAULT, color: Theme.of(context).textTheme.bodyText1.color),
              ),
            )
          ],
        ),
