...
import 'package:bittsave/helper/custom_launch_url.dart';
                      ...
                      SizedBox(
                        ...
                        child: CarouselSlider.builder(
                          ...
                          itemBuilder: (context, index, realIndex) {
                            ...
                            return InkWell(
                              onTap:
                                  controller.bannerList.length > 0 ? () => CustomLaunchUrl.launchURL(url: controller.bannerList[index].url) : () {},
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: CustomImage(
                                        ...
                                        fit: BoxFit.cover,
                                        placeholder: Images.banner_place_holder),
                                  ),
                                ),
                              ),
                            );
