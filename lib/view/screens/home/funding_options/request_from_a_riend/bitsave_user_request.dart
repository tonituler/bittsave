...
class _BittSaveUserRequestState extends State<BittSaveUserRequest> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(body: BackGroundColr1(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding:
                      const EdgeInsets.only(top: 30.0, left: 12, bottom: 60),
                  child: Text(
...
class BackGroundColr1 extends StatelessWidget {
  const BackGroundColr1({Key key, this.child}) : super(key: key);
  final Widget child;
  @override
  Widget build(BuildContext context) {
    return Container(
