...
import 'package:bittsave/view/screens/history/widget/history_shimmer.dart';
                  ...
                  ? Padding(
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (ctx, index) {
                            return Container(child: TransactionHistoryCardWidget(transactions: transactionList[index]));
                          }),
                    )
