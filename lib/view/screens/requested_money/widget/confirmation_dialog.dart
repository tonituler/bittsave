        ...
        child: Stack(clipBehavior: Clip.none, children: [
          Positioned(
            ...
            child: Container(
              ...
              decoration:
                  BoxDecoration(color: widget.isAccept ? ColorResources.getAcceptBtn() : ColorResources.getRedColor(), shape: BoxShape.circle),
          ...
          GetBuilder<RequestedMoneyController>(builder: (reqController) {
            return Padding(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                widget.title != null ? Text(widget.title, style: montserratRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)) : SizedBox(),
                SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                Text(widget.description, textAlign: TextAlign.center, style: montserratRegular),
