...
import 'package:bittsave/view/screens/more/widget/language_widget.dart';
                  ...
                  child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Padding(
                      ...
                      child: Text('select_language'.tr,
                          style: montserratMedium.copyWith(color: ColorResources.getPrimaryTextColor(), fontSize: Dimensions.FONT_SIZE_EXTRA_LARGE)),
                    ),
