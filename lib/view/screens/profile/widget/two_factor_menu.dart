      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            Text('two_factor_authentication'.tr, style: montserratRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
            Spacer(),
            GetBuilder<ProfileController>(
                builder: (profController) =>
                    profController.isLoading ? Center(child: Text('off'.tr)) : Text(profController.userInfo.twoFactor ? 'on'.tr : 'off'.tr)),
