...
import 'package:bittsave/view/base/contact_view.dart';
...
import 'package:bittsave/view/screens/transaction_money/widget/scan_button.dart';
                      ...
                      Expanded(
                          child: TextField(
                              ...
                              decoration: InputDecoration(
                                  ...
                                  hintStyle:
                                      montserratRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, color: ColorResources.getGreyBaseGray1()),
                                    ...
                                    if (value.isOk) {
                                      ...
                                      Get.to(() => TransactionMoneyBalanceInput(
                                          ...
                                          contactModel: ContactModel(
                                              phoneNumber: _countryCode + _searchController.text, name: _agentName, avatarImage: _agentImage)));
                                    }
                                  });
                                } else {
                                  Get.find<TransactionMoneyController>().checkCustomerNumber(phoneNumber: phoneNumber).then((value) {
                                    if (value.isOk) {
                                      ...
                                      Get.to(() => TransactionMoneyBalanceInput(
                                          transactionType: widget.transactionType,
                                          contactModel: ContactModel(
                                              phoneNumber: _countryCode + _searchController.text, name: _customerName, avatarImage: _customerImage)));
                                    }
                                  });
                                }
                              }
                            },
                            child: GetBuilder<TransactionMoneyController>(builder: (checkController) {
            ...
            child: Column(
              children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text('suggested'.tr, style: montserratMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                              ),
                              Container(
                                height: 80.0,
                                child: ListView.builder(
                                    itemCount: sendMoneyController.sendMoneySuggestList.length,
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text(
                                                      sendMoneyController.sendMoneySuggestList[index].name == null
                                                          ? sendMoneyController.sendMoneySuggestList[index].phoneNumber
                                                          : sendMoneyController.sendMoneySuggestList[index].name,
                                                      style: sendMoneyController.sendMoneySuggestList[index].name == null
                                                          ? montserratLight.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL)
                                                          : montserratRegular.copyWith(fontSize: Dimensions.FONT_SIZE_DEFAULT)),
                                                )
                                              ],
                                            ),
                                          ),
                            ...
                            return requestMoneyController.isLoading
                                ...
                                : Padding(
                                    padding: const EdgeInsets.symmetric(
                                        vertical: Dimensions.PADDING_SIZE_SMALL, horizontal: Dimensions.PADDING_SIZE_LARGE),
                                    child: Column(
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        ...
                                        Container(
                                          height: 80.0,
                                          child: ListView.builder(
                                              itemCount: requestMoneyController.requestMoneySuggestList.length,
                                              scrollDirection: Axis.horizontal,
                                              itemBuilder: (context, index) => CustomInkWell(
                                                    radius: Dimensions.RADIUS_SIZE_VERY_SMALL,
                                                    highlightColor: ColorResources.getPrimaryTextColor().withOpacity(0.3),
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: Text(
                                                                requestMoneyController.requestMoneySuggestList[index].name == null
                                                                    ? requestMoneyController.requestMoneySuggestList[index].phoneNumber
                                                                ...
                                                                style: requestMoneyController.requestMoneySuggestList[index].name == null
                                                                    ? montserratLight.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)
                                                                    : montserratRegular.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                                                          )
                                                        ],
                                                      ),
                                                    ),
                                    ...
                                    : Column(
                                        ...
                                        children: [
                                          Padding(
                                            padding: const EdgeInsets.symmetric(
                                                vertical: Dimensions.PADDING_SIZE_SMALL, horizontal: Dimensions.PADDING_SIZE_LARGE),
                                            child: Text('recent_agent'.tr, style: montserratMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
                                          ),
                                          ListView.builder(
                                              itemCount: cashOutController.cashOutSuggestList.length,
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Column(
                                                            ...
                                                            children: [
                                                              Text(
                                                                  cashOutController.cashOutSuggestList[index].name == null
                                                                      ? 'Unknown'
                                                                      : cashOutController.cashOutSuggestList[index].name,
                                                                  style: montserratRegular.copyWith(
                                                                      fontSize: Dimensions.FONT_SIZE_LARGE, color: ColorResources.getBlackColor())),
                                                              Text(
                                                                cashOutController.cashOutSuggestList[index].phoneNumber != null
                                                                    ? cashOutController.cashOutSuggestList[index].phoneNumber
                                                                    : 'No Number',
                                                                style: montserratLight.copyWith(
                                                                    fontSize: Dimensions.FONT_SIZE_DEFAULT, color: ColorResources.getGreyBaseGray1()),
                                                              ),
                                                            ],
                                                          )
                                                        ],
                ...
                widget.transactionType != AppConstants.CASH_OUT
                    ? GetBuilder<TransactionMoneyController>(builder: (contactController) {
