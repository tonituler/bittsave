        ...
        children: [
          Padding(
            ...
            child: Text('amount_in_bdt'.tr,
                style: montserratMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE, color: ColorResources.getGreyBaseGray1())),
          ),
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [
            Text('${PriceConverter.balanceWithSymbol(balance: amountText)}', style: montserratMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
            InkWell(
                onTap: onTap,
