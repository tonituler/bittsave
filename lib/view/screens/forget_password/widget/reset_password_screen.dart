...
import 'package:bittsave/view/screens/forget_password/widget/pin_field_section.dart';
            ...
            child: FloatingActionButton(
              ...
              child: GetBuilder<AuthController>(
                builder: (controller) => !controller.isLoading
                    ...
                    : SizedBox(height: 20.33, width: 20.33, child: CircularProgressIndicator(color: ColorResources.getPrimaryTextColor())),
              ),
            ),
          ),
        ),
