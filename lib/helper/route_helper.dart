...
import 'package:bittsave/view/screens/add_money/web_screen.dart';
import 'package:bittsave/view/screens/auth/create_account/create_account.dart';
import 'package:bittsave/view/screens/auth/login/login_screen.dart';
import 'package:bittsave/view/screens/auth/other_info/other_info_screen.dart';
import 'package:bittsave/view/screens/auth/pin_set/pin_set_screen.dart';
import 'package:bittsave/view/screens/auth/selfie_capture/selfie_capture_screen.dart';
import 'package:bittsave/view/screens/auth/varification/varification_screen.dart';
import 'package:bittsave/view/screens/deshboard/nav_bar.dart';
import 'package:bittsave/view/screens/forget_password/widget/phone_number_screen.dart';
import 'package:bittsave/view/screens/forget_password/widget/varification_screen.dart';
...
import 'package:bittsave/view/screens/home/widget/show_web_view.dart';
import 'package:bittsave/view/screens/more/change_language.dart';
import 'package:bittsave/view/screens/onboarding/chose_login_registration/choice_screen.dart';
import 'package:bittsave/view/screens/notification/notification_screen.dart';
import 'package:bittsave/view/screens/profile/widget/change_pin_screen.dart';
import 'package:bittsave/view/screens/profile/widget/edit_profile_screen.dart';
import 'package:bittsave/view/screens/profile/profile_screen.dart';
import 'package:bittsave/view/screens/profile/widget/faq_screen.dart';
import 'package:bittsave/view/screens/profile/widget/html_view_Screen.dart';
import 'package:bittsave/view/screens/profile/widget/qr_code_download_or_share.dart';
import 'package:bittsave/view/screens/profile/widget/support_screen.dart';
import 'package:bittsave/view/screens/requested_money/requested_money_list_screen.dart';
import 'package:bittsave/view/screens/forget_password/widget/reset_password_screen.dart';
import 'package:bittsave/view/screens/splash/splash_screen.dart';
...
import 'package:bittsave/view/screens/welcome_screen/welcome_screen.dart';
...
class RouteHelper {
  ...
  static getLoginRoute({@required String countryCode, @required String phoneNumber}) =>
      '$login_screen?country-code=$countryCode&phone-number=$phoneNumber';
  ...
  static getSendMoneyConfirmationRoute({@required String inputBalanceText, @required String transactionType}) =>
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        name: send_money,
        page: () => TransactionMoneyScreen(phoneNumber: Get.parameters['phone-number'], fromEdit: Get.parameters['from-edit'] == 'edit-number')),
    ...
    GetPage(
        ...
        page: () => TransactionMoneyConfirmation(
            inputBalance: double.tryParse(Get.parameters['input-balance']), transactionType: Get.parameters['transaction-type'])),
    ...
    GetPage(
        ...
        page: () => FphoneNumberScreen(
              countryCode: Get.parameters['country-code'].replaceAll(' ', '+'),
              phoneNumber: Get.parameters['phone-number'],
            )),
    GetPage(
        name: f_verification_screen,
        page: () => FvarificationScreen(
