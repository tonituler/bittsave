...
import 'package:bittsave/data/model/response/on_boarding_model.dart';
...
class AppConstants {
  ...
  static const String CUSTOMER_DEPOSIT_REQUEST_HISTORY = '/api/v1/customer/get-deposit-request';
  static const String CUSTOMER_CONFIRM_DEPOSIT_REQUEST = '/api/v1/customer/deposit-request/confirm';
  ...
  static const String REQUESTED_MONEY_URI = '/api/v1/customer/get-requested-dashboard-money';
  static const String ACCEPTED_REQUESTED_MONEY_URI = '/api/v1/customer/request-money/approve';
  static const String UPDATE_REQUESTED_MONEY_URI = '/api/v1/customer/request-money';
  ...
  static const String CUSTOMER_GET_DEPOSIT_REQUEST = '/api/v1/customer/get-deposit-request';
  ...
  static const String SEND_USD_TO_BITTSAVE_USER = '/api/v1/customer/usd-wallet-user';
  ...
  static List<OnboardModel> onboardList = [
    OnboardModel(Images.onboard_image_1, Images.onboard_background_1, "Welcome \nto Bittsave",
        "We create a simple way to invest in \nthe future you want later"),
    OnboardModel(
        Images.onboard_image_3, Images.onboard_background_3, "Crypto \nLoans & Savings", "We help you receive and send funds all \nacross the world"),
    OnboardModel(
        Images.onboard_image_2, Images.onboard_background_2, "Send, \nBuy & Sell", "We help by creating financial \nopportunities for everyone"),
  ];
}
