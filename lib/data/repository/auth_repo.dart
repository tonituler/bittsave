...
class AuthRepo extends GetxService {
  ...
  Future<Response> updateToken() async {
    ...
    return await apiClient.postData(
      ...
      {"_method": "put", "token": _deviceToken},
      headers: {'Content-Type': 'application/json; charset=UTF-8', 'Authorization': 'Bearer ${sharedPreferences.get(AppConstants.TOKEN)}'},
    );
  }
  ...
  Future<Response> forgetPassReset({String phoneNumber, String otp, String password, String confirmPass}) async {
    return apiClient
        .putData(AppConstants.CUSTOMER_FORGET_PASS_RESET, {"phone": phoneNumber, "otp": otp, "password": password, "confirm_password": confirmPass});
  }
}
